...
struct ContentView: View {
    ...
    func display() -> (CGImage, [vImagePixelCount]){
        ...
        if(imagePixelData.min()! > myMin.ulp  ){
        
            blackLevel = imagePixelData.min()! * 0.75
        }
        else{
        ...
        if(blurPixelData.min()! > myMin.ulp  ){
        
            blackLevel = blurPixelData.min()! * 0.75
        }
        else{
       ...
       // if ((2*average) > 0.5 )
        ...
        else
        {
            ...
            //bendValue = 0.5* maximum;
//                bendValue = 10*average;
        }
       ...
       // let newBackgroundLevel :Float = 10.0/65535.0
        ...
        if (average < 0.5){
            multiplier = 0.5/average
        }
        else{
        
            multiplier = 0.5*maximum/average
